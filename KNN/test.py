...
# ----------------预测.dat文件----------------
# 替换为实际的数据文件路径
new_file_path = "KNN/data/go22-26m.dat"

# 读取并处理声呐数据
img_8bit_matrix = train_functions.read_sonar_data(new_file_path, nums_photo)
...
for i in range(1, 2):
    ...
    # 重新调整数据形状
    new_sonar_data = train_functions.reshape_img_matrix_single(img_8bit_matrix, photo_show)  # 重新调整数据形状
    # 运行异常点检测
